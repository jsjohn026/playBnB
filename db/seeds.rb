...
listings = Listing.create([
  ...
  {name:'Bay Bridge Bunker', host_id: '5', description: 'Waterside beds and serene cave sounds under the bridge', price: 42, num_bedrooms: 2, max_guests: 2, street_address: '200 Baystreet', city: 'San Francisco', zip_code: '94103', lat: 37.784529, lng: -122.438268 },
  ...
  {name:'Treat Street Bunk', host_id: '5', description: 'Stick with the rest of the pack in a bunk in a shared space', price: 59, num_bedrooms: 1, max_guests: 1, street_address: '2407 Treat Street', city: 'San Francisco', zip_code: '94110', lat: 37.758547, lng: -122.412341 },
  ...
  {name:'Firehouse Space', host_id: '5', description: 'Views of the bay far and wide', price: 200, num_bedrooms: 4, max_guests: 8, street_address: '2396 Fiero Lane', city: 'San Francisco', zip_code: '94104', lat: 37.762245 , lng: -122.401540 }, 
  ...
  {name:'Bay Bridge Bulkhead', host_id: '5', description: 'Waterside beds and serene cave sounds under the bridge', price: 42, num_bedrooms: 2, max_guests: 2, street_address: '198 Baystreet', city: 'San Francisco', zip_code: '94103', lat: 37.784528, lng: -122.438268 },
  ...
  {name:'Treat Street Couch', host_id: '5', description: 'Stick with the rest of the pack in a bunk in a shared space', price: 59, num_bedrooms: 1, max_guests: 1, street_address: '2406 Treat Street', city: 'San Francisco', zip_code: '94110', lat: 37.758567, lng: -122.412341 },
  
  { name:'Sunny Lofty Breezes', host_id: '5', description: 'A sunny living room in a loft with great views of the city', price: 55, num_bedrooms: 1, max_guests: 2, street_address: '3902 18th Street', city: 'San Francisco', zip_code: '94114', lat: 37.761134, lng: -122.431876 },
  
  { name:'Shiny and New', host_id: '3', description: "Inspired by my childhood: In West Philadelphia, born and raised.", price: 355, num_bedrooms: 4, max_guests: 8, street_address: '25 West Philly Road', city: 'San Francisco', zip_code: '94131', lat: 37.761133, lng: -122.431876 },
  
  { name:'The Red Keep', host_id: '4', description: "Check out my weird sister's rad castle. It's cool, she's out of town.", price: 1555, num_bedrooms: 20, max_guests: 16, street_address: '2465 Kings Landing Street', city: 'San Francisco', zip_code: '94133', lat: 37.761567, lng: -122.431876 },
  
  { name:'The Wall', host_id: '4', description: "White view and dead silence. Recently renovated.", price: 25, num_bedrooms: 5, max_guests: 20, street_address: '1 Icy Lane', city: 'San Francisco', zip_code: '94103', lat: 37.761567, lng: -122.431268 },
  
  { name:'Winterfell', host_id: '4', description: "Ex-wife's dark and chilly castle with lots of old memories", price: 1200, num_bedrooms: 12, max_guests: 45, street_address: '15 Windy Lane', city: 'San Francisco', zip_code: '94124', lat: 37.761567, lng: -122.430430 },
  
  { name:'Casterly Rock', host_id: '4', description: "Fond memories of my childhood to peruse. Be sure to check out my dad's gravesite", price: 2200, num_bedrooms: 28, max_guests: 48, street_address: '1690 Moneybags Lane', city: 'San Francisco', zip_code: '94128', lat: 37.768453, lng: -122.430430 },

  { name:'Formation Station', host_id: '1', description: "Organized, strong, and feminine digs for you and your crew", price: 200, num_bedrooms: 4, max_guests: 10, street_address: '100 Flowing Hair Blvd', city: 'San Francisco', zip_code: '94128', lat: 37.768453, lng: -122.434866 },

  { name:'Fashion Palace', host_id: '1', description: "Closet takes up most of the space and has plenty of fashionable outfits for you to try", price: 250, num_bedrooms: 4, max_guests: 4, street_address: '200 Boots Blvd', city: 'San Francisco', zip_code: '94128', lat: 37.768453, lng: -122.434856 },

  { name:'Musical Paradise', host_id: '1', description: "Every instrument you can imagine is available for you to play", price: 276, num_bedrooms: 3, max_guests: 4, street_address: '5162 Notes Lane', city: 'San Francisco', zip_code: '94127', lat: 37.768453, lng: -122.436556 },
])
